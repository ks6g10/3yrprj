...
to compare against an sequential version running on a Intel Xeon W3520 with a clock-speed of 2.67GHz. 
...
Techniques of memory compression, utilization of redundant operation and further optimization's to implement in order to raise performance.
\end{abstract}
